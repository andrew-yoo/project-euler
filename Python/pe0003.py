...
def lenstra_ecm(
    n, max_curves=10000, max_iterations=10000
):  # Must be increased for larger/more complicated numbers to avoid false positives.
...
# This is overly complicated because I mostly copied this from a code I already wrote for general prime factorization using the Lenstra ECM method
