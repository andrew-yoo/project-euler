        ...
        for c in range(remaining_after // coins[2] + 1):
            ...
            for d in range(remaining_after // coins[3] + 1):
                ...
                for e in range(remaining_after // coins[4] + 1):
                    current[4] = e
                    remaining_after = target - (
                        a * coins[0] + b * coins[1] + c * coins[2] + d * coins[3] + e * coins[4]
                    )

                    for f in range(remaining_after // coins[5] + 1):
                        current[5] = f
                        remaining_after = target - (
                            a * coins[0] + b * coins[1] + c * coins[2] + d * coins[3] + e * coins[4] + f * coins[5]
                        )
                        ...
                        for g in range(remaining_after // coins[6] + 1):
                            ...
                            if (
                                sum(current[y] * coins[y] for y in range(8)) == target
                            ):  # Check if the total value equals the target
